export default function Lab1() {
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-p-tag">
        <h4>Paragraph Tag</h4>
        <p id="wd-p-1"> Just checking this... </p>
        <p id="wd-p-2">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          <li>Use Papad from any brand.</li>
          <li>Heat the oil to 300 degrees.</li>
          <li>Put the Papad in the oil for deep fry.</li>
          <li>Cook until golden on top.</li>
          <li>Flip and cook the other side.</li>
          <li>Enjoy the taste of the Indian snack.</li>
        </ol>
